...
def get_parser(victim=False):
    ...
    parser.add_argument('-artifactroot', default='runs', type=str, help='Root directory used to store local experiment metadata, weights, and poison assets')
    parser.add_argument('-workspace', default='local', type=str, help='Logical workspace name under artifactroot')
