...
from tf_compat import tf, xavier_initializer, xavier_initializer_conv2d
import numpy as np
...
class VGG(ConvNet):
    ...
    def construct_weights(self):
        ...
        weights, buffers = {}, {}
        fc_initializer = xavier_initializer(dtype=self.floattype)
    ...
    def weight_layer(self, weights, buffers, id_string, num_filters_in, num_filters_out, size=3, groups=1):
        ...
        conv_initializer = xavier_initializer_conv2d(dtype=self.floattype)
        if groups == 1:
