...
args.craftkey = args.uid if len(args.uid) == 32 else uid2craftkey_with_args(args.uid, args.craftproj, args)
craftexpt = api.get_experiment(args.workspace, args.craftproj, args.craftkey)
...
def victim(kwargs=None):
    ...
    while args.ntrial is None or trial < args.ntrial:
        for craftstep in args.craftsteps:
            experiment = LocalExperiment(project_name=args.victimproj, root=args.artifactroot, workspace=args.workspace)
